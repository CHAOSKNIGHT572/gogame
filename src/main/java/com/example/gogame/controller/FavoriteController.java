...
import com.example.gogame.entity.request.FavoriteRequestBody;
import com.example.gogame.service.FavoriteService;
...
public class FavoriteController {
    ...
    @ResponseBody
    public Map<String, List<Item>> getFavoriteItem(HttpServletRequest request,
